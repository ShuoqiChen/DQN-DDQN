...
class DoubleDQNAgent:
    ...
    def __init__(self, state_size, action_size):
        ...
        if self.load_model:
            self.model.load_weights("./ddqn_mountainCar_dqn.h5")
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            if done:
                ...
                pylab.savefig("./ddqn_mountainCar.png")
        ...
        if e % 50 == 0:
            ...
            np.savez('./ddqn-mountainCarV0-train-result', scores=scores,
            ...
            if e % 500 == 0:
                np.savez('./ddqn-mountainCarV0-test-result', test_scores=test_scores, test_episodes=test_episodes)
                
                # save model weights
                agent.model.save_weights("./ddqn_mountainCar_dqn.h5")
